  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Sathi Seva specific variants
        hero: "gradient-hero text-white hover:shadow-glow shadow-xl font-semibold tracking-wide",
        client: "bg-primary text-primary-foreground hover:bg-primary-hover border-2 border-transparent hover:border-primary-hover/20 shadow-lg hover:shadow-xl transition-bounce",
        worker: "bg-secondary text-secondary-foreground hover:bg-secondary-hover border-2 border-transparent hover:border-secondary-hover/20 shadow-lg hover:shadow-xl transition-bounce",
        ...
        verified: "bg-verified text-white hover:bg-verified/90 shadow-md",
        pending: "bg-pending text-warning-foreground hover:bg-pending/90 shadow-md",
      },
      size: {
